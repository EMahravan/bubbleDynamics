...
openFOAMReader1 = OpenFOAMReader(FileName='/home/user/OpenFOAM/user-dev/run/LIFT/1_NewSeri_MainCase/a.foam')
openFOAMReader1.CaseType = 'Decomposed Case'
openFOAMReader1.MeshRegions = ['internalMesh']
openFOAMReader1.CellArrays = ['T', 'T.air', 'T.water', 'U', 'alpha.water', 'magGradRho', 'maxGradRho', 'p', 'p_rgh', 'rho']

# create a new 'Slice'
slice1 = Slice(Input=openFOAMReader1)
...
clip1.Value = 883162.390625
clip1.InsideOut = 1

# init the 'Box' selected for 'ClipType'
clip1.ClipType.Bounds = [0.0, 0.00019999999494757503, 0.0, 0.0006000000284984708, 0.0, 0.0]
clip1.ClipType.Scale = [0.3, 0.25, 1.0]
...
calculator1.Function = 'p_rgh/126875.931'
...
glyph1.MaximumNumberOfSamplePoints = 700
glyph1.Seed = 1000
...
normalizedpressurePWF.Points = [0.00020513146484375, 0.0, 0.5, 0.0, 0.9710699679516046, 1.0, 0.5, 0.0]
...
glyphScaleLUT.RGBPoints = [2000.0, 0.278431372549, 0.278431372549, 0.858823529412, 388974.7310000788, 0.0, 0.0, 0.360784313725, 773243.3449996063, 0.0, 1.0, 1.0, 1162924.1930002363, 0.0, 0.501960784314, 0.0, 1547192.8069997637, 1.0, 1.0, 0.0, 1934167.5379998425, 1.0, 0.380392156863, 0.0, 2321142.268999921, 0.419607843137, 0.0, 0.0, 2708117.0, 0.878431372549, 0.301960784314, 0.301960784314]
glyphScaleLUT.ColorSpace = 'RGB'
...
glyphScalePWF.Points = [2000.0, 0.0, 0.5, 0.0, 2708117.0, 1.0, 0.5, 0.0]
...
clip1Display.ColorArrayName = ['POINTS', 'alpha.water']
clip1Display.LookupTable = alphawaterLUT
clip1Display.OSPRayScaleArray = 'p'
clip1Display.OSPRayScaleFunction = 'PiecewiseFunction'
clip1Display.SelectOrientationVectors = 'U'
clip1Display.ScaleFactor = 1.2000000424450263e-05
clip1Display.SelectScaleArray = 'p'
clip1Display.GlyphType = 'Arrow'
clip1Display.GlyphTableIndexArray = 'p'
clip1Display.DataAxesGrid = 'GridAxesRepresentation'
clip1Display.PolarAxes = 'PolarAxesRepresentation'
clip1Display.ScalarOpacityFunction = alphawaterPWF
clip1Display.ScalarOpacityUnitDistance = 1.6795138920840807e-06
